...
panel.port.on('deprecated', function() {
  Priv8Overlay.panelManager(Priv8Overlay.PRIV8_DEPRECATED);
  panel.hide();
});
...
let Priv8Overlay = {
  ...
  _panelManagerPage: function(win, page) {
    ...
    if (page == this.PRIV8_DEPRECATED) {
      win.priv8ManagerData.pageDeprecated();
    }
